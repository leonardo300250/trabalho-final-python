...
class ContatoModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'celular': forms.NumberInput(attrs={'placeholder':'Digite seu celular...','class': 'form-control'}),
            'assunto': forms.TextInput(attrs={'placeholder': 'Assunto da mensagem', 'class': 'form-control'}),
            'descricao': forms.Textarea(attrs={'placeholder':'Digite sua mensagem...', 'class': 'form-control'}),
